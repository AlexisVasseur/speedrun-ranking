...
function startRotation() {
  ...
  rotationInterval = window.setInterval(() => {
    ...
    setTimeout(() => {
      // Change group
      currentGroupIndex.value = (currentGroupIndex.value + 1) % rotatingGroups.value.length
      // Fade in
      ...
      <Transition name="fade">
        ...
        <div class="column right-column-container">
          <Transition name="slide-fade" mode="out-in">
            <div v-if="showRightColumn && currentGroup.length > 0" :key="currentGroupIndex" class="right-column-content">
              <div
